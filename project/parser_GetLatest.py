...
with open('./output.csv', 'w', newline='') as f:
    ...
    writer.writerow(['id', 'Data-Time', 'Name', 'Symbol', 'Price-$ (USD)','Market Cap', 
                     'Market Cap Dominance', 'Circulating Supply','is_infinite_supply', 
                     'Volume(24h)','%Change 1h','%Change 24h', '%Change 7-days', '%Change in 30d', 
                     '%Change in 60d','%Change in 90d'])
